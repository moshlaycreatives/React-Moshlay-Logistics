...
export default function Contact() {
  ...
  async function handleSubmit() {
    await axios.post(endpoints.QuoteRequestApi, formData);
      ...
      <section className="section">
        <div className="wrap">
          <div className="contact-grid">
            ...
            <DemoForm className="cform reveal" onSubmit={handleSubmit}>
              ...
              <div className="row">
                ...
                <div className="field-group"><label htmlFor="lname">Last Name</label><input id="lname" type="text" placeholder="Enter last name" value={formData.last_name} onChange={update("last_name")} required /></div>
              </div>
              <div className="row">
                <div className="field-group"><label htmlFor="origin">Shipping Origin</label><input id="origin" type="text" placeholder="City, State" value={formData.shipping_origin} onChange={update("shipping_origin")} required /></div>
                <div className="field-group"><label htmlFor="dest">Shipping Destination</label><input id="dest" type="text" placeholder="City, State" value={formData.shipping_destination} onChange={update("shipping_destination")} required /></div>
              </div>
              <div className="row">
                <div className="field-group"><label htmlFor="date">Preferred Ship Date</label><input id="date" type="date" value={formData.preferred_ship_date} onChange={update("preferred_ship_date")} /></div>
              ...
              <div className="field-group"><label htmlFor="email">Email Address</label><input id="email" type="email" placeholder="you@example.com" value={formData.email} onChange={update("email")} required /></div>
              <div className="field-group"><label htmlFor="comments">Comments / What are you shipping?</label><textarea id="comments" placeholder="Tell us about your load — dimensions, weight, vehicle or equipment type, timeline…" value={formData.comments} onChange={update("comments")}></textarea></div>

              <label className="consent"><input type="checkbox" checked={formData.consent} onChange={update("consent")} required />
